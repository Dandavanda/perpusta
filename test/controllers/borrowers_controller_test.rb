...
class BorrowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create borrower" do
    assert_difference('Borrower.count') do
      post borrowers_url, params: { borrower: { books: @borrower.books, date: @borrower.date, users: @borrower.users } }
    end
  ...
  test "should update borrower" do
    patch borrower_url(@borrower), params: { borrower: { books: @borrower.books, date: @borrower.date, users: @borrower.users } }
